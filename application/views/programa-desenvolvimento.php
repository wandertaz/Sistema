              ...
              <div class="content-interna">
                <div class="left-internas">
				  ...
				  <div class="miolo-interna">
					<div class="cursos">
						<h3>Programas de Desenvolvimento e Universidade Corporativa</h3>
					    ...
					    <div class="box-search-cursos">
					    	...
					    	<form action="<?php echo site_url('educacao_corporativa/programas_desenvolvimento'); ?>" method="GET">
					...
					<?php if($cursos): ?>
						<?php foreach($cursos as $curso): ?>
							<div class="grade">
								<div class="box-foto"><img  width="102" height="160" img src="<?php echo base_url(); ?>assets/uploads/<?php echo $curso->imagem; ?>" width="102" height="160" alt="" /><span></span></div>
		                        <div class="text-programacao">
									...
									<a href="<?php echo site_url('educacao_corporativa/ver_programa_desenvolvimento/'.$curso->id.'/'.$curso->url); ?>" class="ler-mais">Ler mais</a>
		                        </div>
		                        <div class="links">
                                   ...
                                   <?php endif;?>
									...
									<span class="sep"></span>
									<img src="<?php echo base_url(); ?>assets/img/icon-pen.png" /><a class="various" data-fancybox-type="iframe" href="<?php echo site_url('educacao_corporativa/solicitar_proposta/DE/'.$curso->id); ?>">Solicitar</a> proposta comercial
