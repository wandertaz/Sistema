 <nav class="menu">
                	<ul>
                        ...
                        <li><a style="cursor:pointer;">SERVI&Ccedil;OS</a>
                            <ul class="sub-servicos">
                              ...
                              <li><a href="<?php echo site_url('servicos/governanca_corporativa'); ?>">Governança Coorporativa</a></li>
                     		</ul>
                        </li>
                          ...
                          <ul class="sub-programa">
                            ...
                            <li>
                              ...
                              <ul>
                                    ...
                                    <li><a href="<?php echo $this->session->userdata('SessionIdAluno')? site_url('bancodetalentos/meucurriculo') :site_url('loginlogout/index?url=bancodetalentos/meucurriculo'); ?>">Cadastrar Curriculo</a></li>
                                    <li><a href="<?php echo $this->session->userdata('logged_in_Empresa') ||$this->session->userdata('logged_in_Permissao_Juridica')? site_url('bancodetalentos_empresa/cadastrar_vaga') :site_url('loginlogout/index?url=bancodetalentos_empresa/cadastrar_vaga'); ?>">Cadastrar Vaga</a></li>
