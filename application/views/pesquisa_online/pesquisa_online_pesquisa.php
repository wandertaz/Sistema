...
<?php if(isset($perguntas)): ?>
            <div class="box-form-pesquisa-online clear-both">
                <form action="<?php echo isset($pesquisa_sugestao)?site_url('pesquisa_online/salvar_questionario_sugestao'):site_url('pesquisa_online/salvar_questionario');?>" id="pesquisa-online-pesquisa" class="clear-both <?php if(!isset($pesquisa_sugestao)) echo 'validate'; ?>" method="post">
                        ...
                        <li class="clear-both">
                            <div class="enterprise-infos-two-cols">
                                ...
                                <div class="the-col">
                                   ...
                                   <!-- <label class="enterprise-infos-label" for="pesquisa_on_cel">
                                        <span class="enterprise-infos-label">Celular</span>
                                        <input type="text" name="pesquisa_on_cel" id="pesquisa_on_cel" value="<?php //echo$pesquisado->celular;?>">
                                    </label>-->
                                </div>
                                <div class="the-col">
                                                    ...
                                                    <?php foreach($pergunta->opcoes as $opcao): ?>
                                                        <label class="el" for="">
                                                                <input type="checkbox" <?php echo isset($pesquisa_sugestao)?'disabled="disabled"':'' ?> name="<?php echo isset($pesquisa_sugestao)?'':$pergunta->id_pesquisas_perguntas; ?>[]" value="<?php echo $opcao->id_pesquisas_perguntas_opcoes; ?>">
                                                                    <?php echo $opcao->opcao; ?><?php if ( $opcao->tipo == 'A' ) : ?> - <input type="text" name="aberto_<?php echo isset($pesquisa_sugestao)?'':$opcao->id_pesquisas_perguntas_opcoes; ?>" size="40"><?php endif; ?>
                                                        </label>
			...
			<?php endforeach; ?>
                        ...
                        <?php if(isset($pesquisa_sugestao)):?> 
                            ...
                            <div class="botoes-pesquisa">
                                <a href="javascript: $('#acao').val('nao'); $('#pesquisa-online-pesquisa').submit();" class="nao-aprovar"><img src="<?php echo site_url(); ?>assets/img/botao-solicitar-revisao.png" alt="Não aprovar" title="Não aprovar" /></a>
								...
								<a href="<?php echo site_url('/pesquisa_online/aprovar/'.$pesquisa->id_pesquisas) ?>" class="botao-aprovar-pesquisa"><img src="<?php echo site_url(); ?>assets/img/botao-aprovar-questionario.png" alt="Aprovar" title="Aprovar" /></a>
