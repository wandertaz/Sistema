...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	...
	<tr>
		...
		<h1 style="font-size:22px; font-weight:normal; line-height:22px; margin:0 0 11px 0; color:#F7931E; text-transform:uppercase">Ol&aacute;, MB Consultoria <?php //echo utf8_decode($usuario); ?></h1>
                ...
                <p style="font-size:12px; line-height:16px; margin:0;"> Um novo or&ccedil;amento de pesquisa foi gerado no dia (<?php echo br_date($orcamento[0]->created); ?>) e esta presente na sua &aacute;rea restrita<br /></p>
	...
	<tr>
		<td valign="top">
                    <p style="font-size:12px; line-height:16px; margin:0;"> Voc&ecirc; pode avaliar o or&ccedil;amento de pesquisa na sua &aacute;rea restrita no site da MB Consultoria</p>
