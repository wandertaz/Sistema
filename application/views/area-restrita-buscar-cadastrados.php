...
?>
    ...
    // exit();
                ...
                <?php else:?>
                <p style="color: #F7931E;margin-top: 44px;display: block;clear: both;overflow: hidden;font-size: 13px;text-align: center;"> O aluno que você procura não existe.<br /> <a style="color:#F7931E;font-weight:bold;" class="various" data-fancybox-type="iframe" href="<?php echo site_url();?>gerenciarinscritos/novocadastro_inscrito">CLIQUE AQUI</a> se deseja adicionar um novo aluno.</p>
                <?php endif;?>
                </div>                  
               <?php endif; ?> 
              </div>
