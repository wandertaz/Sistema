        ...
        <form id="form_cadastro_de_vagas" method="post" action="<?php echo site_url('bancodetalentos_empresa/salvar_vaga'); ?>">
            <div class="centerCursos equalH-meus-cursos bancodetalentos_content">
                ...
                <div id="cadastrar_vagas" class="holder_cadastro_curriculo">
                    ...
                    <label for="desc_vaga_cadastrar_vagas"><span>Breve Descrição da Vaga</span>
                        <textarea name="descricao" class="inpt_cadastro_curriculo big_inpt_cadastro_curriculo" id="desc_vaga_cadastrar_vagas" cols="30" rows="5"><?php echo (isset($registro) ? $registro->descricao : ''); ?></textarea></label>
                    </label>
                    ...
                    <div class="secound_col hidden-bg">
                        <label style="position: relative;top: -9px;" class="to-left" for="cidade_de_atuacao_cadastrar_vagas"><span>Cidade onde o profissional irá atuar </span>
                            <input type="text" name="cidade_atuacao" id="cidade_de_atuacao_cadastrar_vagas" class="inpt_cadastro_curriculo small_inpt_cadastro_curriculo" value="<?php echo (isset($registro) ? $registro->cidade_atuacao : ''); ?>" /></label>
                    </div>
                    ...
                    <label for="" class="to-left"><span>Qualificação (outros cursos importantes)</span>
                      ...
                      <div class="num-col-2 clear-both">  
                        ...
                        <div class="col" style="width: 140px;">
                            <label for="" class="inpt_checkbox">
                                <input type="radio" name="experiencia" id="experiencia" value="Não é necessária experiência" <?php echo (isset($registro) ? $registro->experiencia=='Não é necessária experiência'?'checked=""':'': ''); ?>/>
                                <span>Não é necessária experiência</span>
                            </label>
                             <label for="" class="inpt_checkbox">
                                <input type="radio" name="experiencia" id="experiencia" value="6 meses a 1 ano" <?php echo (isset($registro) ? $registro->experiencia=='6 meses a 1 ano'?'checked=""':'': ''); ?> />
                                <span>6 meses a 1 ano</span>
                            </label>
                            <label for="" class="inpt_checkbox">
                                <input type="radio" name="experiencia" id="experiencia"  value="1 a 2 anos" <?php echo (isset($registro) ? $registro->experiencia=='1 a 2 anos'?'checked=""':'': ''); ?>/>
                                <span>1 a 2 anos</span>
                            </label>
                            
                            <label for="" class="inpt_checkbox">
                                <input type="radio" name="experiencia" id="experiencia"  value="2 a 4 anos" <?php echo (isset($registro) ? $registro->experiencia=='2 a 4 anos'?'checked=""':'': ''); ?> />
                                <span>2 a 4 anos</span>
                            </label>
                            <label for="" class="inpt_checkbox">
                                <input type="radio" name="experiencia" id="experiencia"  value="Acima de 5 anos" <?php echo (isset($registro) ? $registro->experiencia=='Acima de 5 anos'?'checked=""':'': ''); ?> />
                                <span>Acima de 5 anos</span>
                            </label>
                             <label for="" class="inpt_checkbox">
                                <input type="radio" name="experiencia" id="experiencia"  value="Acima de 10 anos" <?php echo (isset($registro) ? $registro->experiencia=='Acima de 10 anos'?'checked=""':'': ''); ?>/>
                                <span>Acima de 10 anos</span>
                            </label>
                        </div>
                      </div>
                      <hr class="hr_sep" style="margin-bottom: 24px;" />
                       ...
                       <!-- <span class="label-cols">Experiência</span>
                        ...
                        <div class="col" style="width: 140px;">
                            ...
                            <?php foreach ($pretensoes_salariais as $pretensao_id => $pretensao_nome): ?>
                                <label for="" class="inpt_checkbox">
                                    <input type="radio" name="pretensao_salarial_id" id="" value="<?php echo $pretensao_id; ?>" <?php echo isset($faixa_salarial) && $faixa_salarial == $pretensao_id ? 'Checked' : ''; ?> ><span><?php echo $pretensao_nome; ?></span>
                                </label>
                            <?php endforeach; ?>
                    ...
                    <div class="num-col-2 clear-both">
                        ...
                        <div class="col idioma_cad_vaga">
                            <?php $x = 0; ?>
                            <?php foreach ($idiomas_vagas as $idioma_vaga): ?>

                                <div class="idioma_origin set_idioma_add" style="width: 405px;padding-right: 10px;">
                    ...
                    <div class="set" style="border-top: 1px solid #ddd;margin-top: 20px;padding-top: 10px;">
                        ...
                        <div class="first_col cad_vaga_sexo">
