   ...
   <!-- <ul>
    ...
    <!-- Left Sidebar -->
     ...
     <div class="centerCursos equalH-meus-cursos bancodetalentos_content">
      ...
      <h2>
      <?php if($msg == 'sucesso'): ?>
	     Obrigada por atualizar o curriculo! Conte conosco e sucesso em sua busca profissional!
	    <?php endif; ?>
      </h2>
      ...
      <div id="formacoes_academicas" class="holder_cadastro_curriculo container_page_cadastro_curriculo">
        ...
        <label for="" class="to-left"><span>Início </span><input   value="<?php echo $itens['vazio']==0? ($itens['data_inicio']):'';?>" type="text" name="inicio_form_academica_<?php echo $x;?>" class="mes_ano inpt_cadastro_curriculo small_inpt_cadastro_curriculo" /></label>
        <label for="" class="to-left"><span>Conclusão</span><input value="<?php echo $itens['vazio']==0? ($itens['data_conclusao']):'';?>" type="text" name="conclusao_form_academica_<?php echo $x;?>" class="mes_ano inpt_cadastro_curriculo small_inpt_cadastro_curriculo" /></label>
        </div>
          <?php
        ...
        <label for="" class="to-left"><span>Início </span><input type="text" value="<?php echo $itens['vazio']==0? ($itens['data_inicio']):'';?>" name="inicio_complementar_form_academica[]" class="mes_ano inpt_cadastro_curriculo small_inpt_cadastro_curriculo" /></label>
        <label for="" class="to-left"><span>Conclusão</span><input type="text" value="<?php echo $itens['vazio']==0? ($itens['data_conclusao']):'';?>" name="conclusao_complementar_form_academica[]" class="mes_ano inpt_cadastro_curriculo small_inpt_cadastro_curriculo" /></label>
        </div>
          <?php
