	        ...
	        <div class="content-meu-curriculo">
	        	...
	        	<?php if($formacao_academica): ?>
		          <h2>Formação Acadêmica</h2>
			          ...
			          <strong style="margin-left:10px;">início:</strong>  <span><?php echo br_date($formacao->data_inicio); ?></span> <br />
			          <strong style="margin-left:10px;">conclusão:</strong>  <span><?php echo br_date($formacao->data_conclusao); ?></span><br />
			  			<br />
					<?php endforeach; ?>
			  	<?php endif; ?>
          		...
          		<?php if($cursos_complementares): ?>
			          ...
			          <span style="margin-left:10px;"><?php echo br_date($curso->data_inicio); ?> até <?php echo br_date($curso->data_fim); ?> - Carga Horária: <?php echo $curso->carga_horaria; ?></span><br />
