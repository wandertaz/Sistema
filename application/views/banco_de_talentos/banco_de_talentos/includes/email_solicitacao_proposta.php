...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	...
	<tr>
		...
		<p style="font-size:12px; margin:2;"> <b style="text-transform:uppercase; color:#F7931E;">A empresa possui infra-estrutura: </b> <?php echo $post['infra']; ?>
			<?php if($post['outraInfra']): ?>
				<br /><?php echo 'Outro: '.$post['outraInfra']; ?>
			<?php endif; ?>
		</p>
