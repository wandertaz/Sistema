...
?>
                    ...
                    <div class="set clear-both" style="border-top: 1px solid #ddd;margin-top: 20px;padding-top: 10px;">
                    ...
                    <div class="clear-both" style="padding-left: 25px;">
                        <div class="custom_columns">
	                	<h3 style="width: 77px;">Estado Civil</h3>
                        <div class="first_col">
						<?php foreach ($estados_civis as $flag_estado => $estado_civil): ?>
                         ...
                         <div class="custom_columns">   
                        <h3 style="width: 76px;">Portador de Necessidades Especiais?</h3>
                    	<div class="first_col">
