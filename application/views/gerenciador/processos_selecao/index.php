<div id="tabela">
	...
	<table cellpadding="0" cellspacing="0">
		<tr>
			<th class="marcado-th"><a href="#">Processo</a></th>
			<th>Empresa</th>
			<th>Status</th>
			<th>Data</th>
			<th>Resultados Por Currículo</th>
		...
		<?php foreach($registros as $row):?>
			<tr class="altrow">
				...
				<td><?php echo $row->status == 'A' ? 'Em Andamento' : 'Concluído';?></td>
				<td><?php echo br_date($row->created); ?></td>
				<td><?php echo anchor('multitools/processos_curriculos/index/'.$row->id_processo, 'Resultados por Currículo', NULL); ?></td>
				<td class="actions">
					<?php echo anchor($controller.'/editar/'.$row->id_processo, 'Editar', NULL); ?>
		            <?php echo anchor($controller.'/excluir/'.$row->id_processo, 'Excluir', array("onclick"=>"return confima_exclusao('$title_sing')"));?>
				</td>
			</tr>
		<?php endforeach;?>
	</table>
