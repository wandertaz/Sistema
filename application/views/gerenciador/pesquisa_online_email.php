...
<head>
  ...
  <style type="text/css">
    ...
    Bring inline: Yes. */
    h1, h2, h3, h4, h5, h6 {color: #F8931F !important;}

    h1 a, h2 a, h3 a, h4 a, h5 a, h6 a {color: #F8931F !important;}
    ...
    <table cellpadding="0" cellspacing="0" border="0" align="center" style="width:600px;margin:0 auto;">
      ...
      <tr>
        <td width="600" valign="top" style="padding: 15px 0 25px;">
          <p style="font-family:Arial, sans-serif; font-size:13px;">Sr(a). XXX, bom dia!</p>
          
          <?php echo $pesquisa->mensagem_email;?>
<!--
          <p style="font-family:Arial, sans-serif; font-size:13px;">Esta Pesquisa de Opinião é muito importante para o segmento da Transportes e Logística na Amazônia e que será fundamental para conhecermos as reais e mais atuais necessidades que são usuárias do sistema na região.</p>

          <p style="font-family:Arial, sans-serif; font-size:13px;">Pedimos sua cooperação na participação desta pesquisa e bastam 5 minutos de seu tempo.</p>
-->
          ...
          <p style="font-family:Arial, sans-serif; font-size:13px;"><a style="font-family:Arial, sans-serif; font-size:13px;" href="<?php echo site_url('pesquisa_online/pesquisa_sugestao/'.$pesquisa->id_pesquisas); ?>"><?php echo utf8_decode('Clique aqui e Participe.'); ?></a></p>

         <!-- <p style="font-family:Arial, sans-serif; font-size:13px;"><?php //echo utf8_decode('Desde já agradecemos sua valiosa contribuição, que nos ajudará a influenciar todo o setor. Nos mantemos à disposição para qualquer esclarecimento com relação a esta pesquisa e seus objetivos.');?></p>-->
           <?php echo $pesquisa->agradecimentos;?>
        </td>
      </tr>
      <tr>
        <td width="600" valign="top"><img src="<?php echo site_url(); ?>/assets/img/news-pesquisa-online-rodape.jpg" alt="" /></td>
      </tr>
    </table>
