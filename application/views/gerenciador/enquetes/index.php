	...
	<table cellpadding="0" cellspacing="0">
		...
		<?php foreach($registros as $row):?>
			<tr class="altrow">
				...
				<td><?php echo anchor('/multitools/enquetes_alternativas/', 'Gerenciar Alternativas', NULL);?></td>
				<td><?php echo anchor('/multitools/enquetes/resultado/'.$row->id, 'Ver Resultado', NULL);?></td>
				<td class="actions">
