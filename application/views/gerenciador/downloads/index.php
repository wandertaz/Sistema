	...
	<table cellpadding="0" cellspacing="0">
		...
		<?php foreach($registros as $row):?>
			<tr class="altrow">
				...
				<td><?php echo anchor('multitools/downloads_versoes/index/'.$row->id_downloads, 'Gerenciar Versões', NULL);?></td>
				<td class="actions">
					<?php echo anchor($controller.'/editar/'.$row->id_downloads, 'Editar', NULL);?>
		            <?php echo anchor($controller.'/excluir/'.$row->id_downloads, 'Desativar', array("onclick"=>"return confima_exclusao('$title_sing')"));?>
				</td>
			</tr>
		<?php endforeach; ?>
	</table>
