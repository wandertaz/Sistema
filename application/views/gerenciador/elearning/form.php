	...
	<?php echo form_open_multipart($controller.'/salvar', array("id" => "form"));?>
	  	...
	  	<fieldset>
			...
			<div class="input text obrigatorio">
	 			...
	 			<span> (Tamanho indeterminado)</span>
			</div>
			...
			<div class="input text obrigatorio">
	 			<label for="publico_alvo">Público Alvo</label><br />
			...
			<div class="input text obrigatorio">
	 			<label for="codigo_video">Código do Vídeo de Apresentação (Youtube)</label>
	 			<input name="codigo_video" id="codigo_video" type="text" value="<?php echo (isset($registro) ? $registro->codigo_video : ''); ?>" />
			</div>
