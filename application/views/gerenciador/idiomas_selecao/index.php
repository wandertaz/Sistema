<div id="tabela">
	...
	<table cellpadding="0" cellspacing="0">
		...
		<?php foreach($registros as $row):?>
			<tr class="altrow">
				<td><?php echo $row->nome_idioma;?></td>
				<td><?php echo $row->ativo == 'S' ? 'Sim' : 'Não';?></td>
				<td class="actions">
					<?php echo anchor($controller.'/editar/'.$row->id_idioma, 'Editar', NULL);?>
		            <?php echo anchor($controller.'/excluir/'.$row->id_idioma, 'Desativar', array("onclick"=>"return confima_exclusao('$title_sing')"));?>
				</td>
			</tr>
		<?php endforeach;?>
	</table>
