<div id="tabela">
	...
	<div id="cima">
		...
		<div class="adicionar">
			<?php echo anchor($controller.'/adicionar/'.$pergunta_id, img('assets/imagens/multitools/botao_adicionar.png', 'array("alt"=>"Novo ".$title_sing)'));?>
		...
		<?php echo form_open($controller.'/buscar', array('id' => 'UserIndexForm', 'method' => 'get'));?>
			<div class="busca">
				...
				<input type="hidden" name="pergunta_id" id="pergunta_id" value="<?php echo $pergunta_id;  ?>" />
	...
	<div id="msg"><?php echo $this->session->flashdata('msg');?>
