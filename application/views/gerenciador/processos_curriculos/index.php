<div id="tabela">
	...
	<table cellpadding="0" cellspacing="0">
		<tr>
			<th class="marcado-th"><a href="#">Currículo</a></th>
			<th>Processo</th>
			<th>Data</th>
		...
		<?php foreach($registros as $row):?>
			<tr class="altrow">
				...
				<td class="actions">
					<?php echo anchor($controller.'/editar/'.$row->processos_curriculos_id, 'Editar', NULL); ?>
		            <?php echo anchor($controller.'/excluir/'.$row->processos_curriculos_id, 'Excluir', array("onclick"=>"return confima_exclusao('$title_sing')"));?>
				</td>
			</tr>
		<?php endforeach;?>
	</table>
