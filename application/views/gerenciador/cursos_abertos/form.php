	...
	<?php echo form_open_multipart($controller.'/salvar', array("id" => "form"));?>
	  	...
	  	<fieldset>
			...
			<div class="input text obrigatorio">
				...
				<textarea name="conteudo" id="conteudo" class="editor"><?php echo (isset($registro) ? $registro->conteudo : ''); ?></textarea>
			</div>

			<div class="input text obrigatorio">
	 			<label for="instrutor">Instrutor</label><br />
				<textarea name="instrutor" id="instrutor" class="editor"><?php echo (isset($registro) ? $registro->instrutor : ''); ?></textarea>
			</div>
