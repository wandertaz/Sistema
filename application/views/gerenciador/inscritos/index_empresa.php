<div id="tabela">
	...
	<div id="cima">
		...
		<div class="adicionar">
			...
			<p>Adicionar <?php echo $tipo == 'J' ? 'Empresa' : 'Inscrito';?></p>
		</div><!--/adicionar -->
			...
			<tr class="altrow">
				...
				<td class="actions">
					<?php echo anchor($controller.'/editar/'.$row->id, 'Editar', NULL);?>
                                        <?php echo anchor($controller.'/gerenciamento_usuarios/'.$row->id, 'Gerenciamento de Usuários', NULL);?>
