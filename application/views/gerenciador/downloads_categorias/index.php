	...
	<table cellpadding="0" cellspacing="0">
		...
		<?php foreach($registros as $row):?>
			<tr class="altrow">
				...
				<td class="actions">
					<?php echo anchor($controller.'/editar/'.$row->id_downloads_categorias, 'Editar', NULL);?>
		            <?php echo anchor($controller.'/excluir/'.$row->id_downloads_categorias, 'Excluir', array("onclick"=>"return confima_exclusao('$title_sing')"));?>
				</td>
			</tr>
		<?php endforeach; ?>
	</table>
