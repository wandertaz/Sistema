	...
	<?php echo form_open_multipart($controller.'/salvar', array("id" => "form"));?>
	  	...
	  	<fieldset>
			...
			<div class="input text obrigatorio">
	 			...
	 			<input name="data" id="data" type="text" value="<?php echo (isset($registro) ? $registro->data : ''); ?>" />
			</div>
			...
			<div class="input text obrigatorio">
	 			<label for="objetivos">Conteúdo</label><br />
				<textarea name="objetivos" id="objetivos" class="required editor"><?php echo (isset($registro) ? $registro->objetivos : ''); ?></textarea>
			</div>

			<div class="input text obrigatorio">
	 			<label for="publico_alvo">Facilitador</label><br />
			...
			<div class="input text obrigatorio">
	 			<label for="requisitos">Didática</label><br />
				<textarea name="requisitos" id="requisitos" class="editor"><?php echo (isset($registro) ? $registro->requisitos : ''); ?></textarea>
			</div>

			<div class="input text obrigatorio">
	 			<label for="local">Local</label>
	 			<input name="local" id="local" type="text" value="<?php echo (isset($registro) ? $registro->local : ''); ?>" />
			</div>
			...
			<div class="input text obrigatorio">
	 			...
	 			<input name="valor" id="valor" type="text" value="<?php echo (isset($registro) ? number_format($registro->valor, 2, ',', '.') : ''); ?>"  maxlength="9" onkeypress="return formataMoeda(this, '.', ',', event);"/>
			</div>
			...
			<div class="input text obrigatorio">
			<p><strong>Pacote para Pessoas Jurídicas:</strong></p>
			</div>

			<div class="input text obrigatorio">
	 			<label for="numero_inscricoes_juridica">Número de Inscrições do pacote</label>
	 			<input name="numero_inscricoes_juridica" id="numero_inscricoes_juridica" type="text" value="<?php echo (isset($registro) ? $registro->numero_inscricoes_juridica : ''); ?>" />
			</div>


			<div class="input text obrigatorio">
	 			<label for="valor_juridica">Valor do Pacote</label>
	 			<input name="valor_juridica" id="valor_juridica" type="text" value="<?php echo (isset($registro) ? number_format($registro->valor_juridica, 2, ',', '.') : ''); ?>"  maxlength="9" onkeypress="return formataMoeda(this, '.', ',', event);" />
			</div>
