<div id="tabela">
	...
	<table cellpadding="0" cellspacing="0">
		<tr>
			<th class="marcado-th"><a href="#">Horário</a></th>
			<th><a href="#">Ativo?</a></th>
			<th class="actions">Ações</th>
		</tr>
		<?php foreach($registros as $row):?>
			<tr class="altrow">
				<td><?php echo $row->disponibilidadehorario_nome;?></td>
				<td><?php echo $row->ativo == 'S' ? 'Sim' : 'Não';?></td>
				<td class="actions">
					<?php echo anchor($controller.'/editar/'.$row->disponibilidadehorario_id, 'Editar', NULL);?>
		            <?php echo anchor($controller.'/excluir/'.$row->disponibilidadehorario_id, 'Desativar', array("onclick"=>"return confima_exclusao('$title_sing')"));?>
				</td>
			</tr>
		<?php endforeach;?>
	</table>
