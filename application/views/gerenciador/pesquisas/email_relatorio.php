...
<table cellspacing="0" cellpadding="0" border="0" width="100%">
	...
	<tr>
		...
		<p style="font-size:12px; line-height:16px; margin:0;">O relat&oacute;rio da pesquisa <b><?php echo ($pesquisa); ?></b> encontra-se dispon&iacute;vel para download. </p>
	</tr>

	<tr>
		<td valign="top">
		<p style="font-size:12px; line-height:16px; margin:0;"> Voc&ecirc; pode fazer o download do relat&oacute;rio na sua &aacute;rea restrita, no site da MB Consultoria: </p>
