<div id="tabela">
	...
	<table cellpadding="0" cellspacing="0">
		<tr>
			<th class="marcado-th"><a href="#">Faixa Salarial</a></th>
		...
		<?php foreach($registros as $row):?>
			<tr class="altrow">
				<td><?php echo $row->pretencaosalarial_nome;?></td>
				<td><?php echo $row->ativo == 'S' ? 'Sim' : 'Não';?></td>
				<td><?php echo $row->ordem;?></td>
				<td class="actions">
					<?php echo anchor($controller.'/editar/'.$row->pretencaosalarial_id, 'Editar', NULL);?>
		            <?php echo anchor($controller.'/excluir/'.$row->pretencaosalarial_id, 'Desativar', array("onclick"=>"return confima_exclusao('$title_sing')"));?>
				</td>
			</tr>
		<?php endforeach;?>
	</table>
