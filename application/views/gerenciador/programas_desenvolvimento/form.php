	...
	<?php echo form_open_multipart($controller.'/salvar', array("id" => "form"));?>
	  	...
	  	<fieldset>
			...
			<!--<div class="input text">
	 			...
	 			<?php //echo form_dropdown("instrutor_id", $instrutores, set_value("instrutor_id", (isset($registro) ? $registro->instrutor_id : "")), "id=\"instrutor_id\" class=\"required\""); ?>
			</div>-->
			...
			<div class="input text obrigatorio">
				...
				<textarea name="texto" id="texto" class="editor required"><?php echo (isset($registro) ? $registro->texto : ''); ?></textarea>
			</div>

			<div class="input text obrigatorio">
	 			<label for="objetivos">Objetivos</label><br />
				<textarea name="objetivos" id="objetivos" class="editor required"><?php echo (isset($registro) ? $registro->objetivos : ''); ?></textarea>
			</div>

			<div class="input text obrigatorio">
	 			<label for="publico_alvo">Resultado</label><br />
				<textarea name="publico_alvo" id="publico_alvo" class="editor required"><?php echo (isset($registro) ? $registro->publico_alvo : ''); ?></textarea>
			</div>
			...
			<!--<div class="input text obrigatorio">
				...
				<textarea name="requisitos" id="requisitos" class="editor required"><?php echo (isset($registro) ? $registro->requisitos : ''); ?></textarea>
			</div>-->

			<div class="input text obrigatorio">
	 			<label for="carga_horaria">Carga Horária</label>
	 			<input name="carga_horaria" id="carga_horaria" type="text" value="<?php echo (isset($registro) ? $registro->carga_horaria : ''); ?>" class="required" />
			</div>
