        ...
        <?php if ($this->session->userdata('logged_in_Permissao_Juridica')): ?>
            <ul>
                ...
                <?php if (strpos($this->session->userdata('SessionAreaPermissoes'), '-7-') > 0): ?>
                    <li <?php echo strpos(uri_string(),'modulo_de_pesquisa')>0 ?'class="selected"':''?>><a href="<?php echo site_url('area_restrita_modulo_de_pesquisa/index/FJ'); ?>">Pesquisas</a></li>
                <?php endif; ?>
            </ul>
        <?php endif; ?>
    <?php endif; ?>
<?php elseif ($this->session->userdata('SessionTipoPessoa') == 'J'): ?>
    <ul>
       ...
       <!-- <li><a href="<?php echo site_url(''); ?>">Gerenciamento de Usuários</a></li>-->
        ...
        <li <?php echo strpos(uri_string(),'modulo_de_pesquisa')>0 ?'class="selected"':''?> ><a href="<?php echo site_url('area_restrita_modulo_de_pesquisa/index/J'); ?>">Pesquisas</a></li>
    </ul>
<?php endif; ?>
<?php // echo (uri_string());?>
