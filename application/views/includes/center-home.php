			...
			<div class="list-blog <?php if($key == 1): ?> ultimo <?php endif; ?>">
				  <div class="box-foto">
				   ...
				   <span class="borda"></span>
                            ...
                            <h3 style="margin-bottom:0px; color:#ff3600;"><?php echo(retorno_colunista($post_home->colunista_id)); ?></h3>
	...
	<?php if(isset($video) && $video): ?>
		<div class="list-multimidia ultimo">
		  ...
		  <h3><?php echo $video[0]->titulo; ?></h3>
		   ...
		   <iframe width="178" height="93" src="http://www.youtube.com/embed/<?php echo $video[0]->codigo; ?>" frameborder="0" allowfullscreen></iframe>
		  </div>
