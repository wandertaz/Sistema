        ...
        <div class="bg2">
            <header>
                <div class="header-1">
                    ...
                    <div class="login">
                        <form name="login" action="<?php echo site_url('busca_site');?>" method="">
                    ...
                    <ul class="redeSocial">
                        <?php $midias = retorna_paginas_midias_sociais();?>
                       
                        <li><a href="<?php echo($midias['link_facebook']);?>" target="_blank" class="face"><span>facebook</span></a></li>
                        <li><a href="<?php echo($midias['link_twitter']);?>"  target="_blank" class="twitter"><span>twitter</span></a></li>
                        <li><a href="<?php echo($midias['link_youtube']);?>"  target="_blank" class="youtube"><span>youtube</span></a></li>
                        <li><a href="<?php echo($midias['link_linkedin']);?>" target="_blank" class="linkeid"><span>linkeid</span></a></li>
                    </ul>
                </div>
