                ...
                <div class="centerCursos equalH-meus-cursos">
                 ...
                 <?php if($inscricoes): ?>
                 	<?php foreach($inscricoes as $item): ?>
						...
						<div class="listagem-autodiagnostico" style="margin-bottom: 5px;margin-left: 2px;">
							...
							<?php elseif($item->status == 'AP'): ?>	
                                                ...
                                                <?php if(trim($item->arquivo_relatorio)!=''): ?>                                                                            
                                                    <div class="adquirir-versao" style="width: 181px;margin: 0 auto;">
                                                      <a href="<?php echo site_url('area_restrita_modulo_de_pesquisa/functionUp_/'.$item->id_pesquisas.'/R/'.$item->chave)?>" class="button-download" title="Fazer download do arquivo">Fazer download do relatório</a>
                                                    </div>                       
                                                <?php else: ?>                                                     
                                                    <div class="adquirir-versao" style="width: 315px;margin: 0 auto;text-align: center;
font-size: 13px;">
                                                     <span>O relatório não esta disponível, na sua area restrita!</span>
                                                     </div>  
                                                <?php endif;?> 
