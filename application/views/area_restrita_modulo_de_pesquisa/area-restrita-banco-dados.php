                 	...
                 	<?php foreach($inscricoes as $item): ?>
						...
						<div style="margin-bottom: 5px;margin-left: 2px;" class="listagem-autodiagnostico">
                            ...
                            <hr>
                                         ...
                                         <h4>FAÇA O UPLOAD DE SUA BASE DE DADOS</h4>
                                                <style>
                                         ...
                                         <form style="float:left;" action="<?php echo site_url('area_restrita_modulo_de_pesquisa/functionSalvaDados/'.$item->id_pesquisas.'/'.$acesso['tipoacesso']);?>" method="post" enctype="multipart/form-data" name="upload">
                                                    <input type="file" name="userfile" style="font-size: 10px;">
                                                    <input type="submit" name="envio" value="enviar">
                                                    
                                                </form>
                                                
                                                <?php if(trim($item->arquivo_dados)!=''): ?>                                                                            
                                                    <div class="adquirir-versao" style="float:right;">
                                                        <a style="margin: 6px 42px 0;" href="<?php echo site_url('area_restrita_modulo_de_pesquisa/functionUp_/'.$item->id_pesquisas.'/B/'.$item->chave)?>" class="button-download" title="Fazer download do arquivo">Fazer download do arquivo</a>
                                                    </div>                       
                                                <?php else: ?>
