...
<!--[if gt IE 8]><!--> <html class="no-js" style="overflow:hidden;"> <!--<![endif]-->
    ...
    <body>
        <form action="<?php echo site_url();?>gerenciamento_email/indicar_amigo_envio" id="form-contato" method="post">
	...
	<div>
		...
		<label for="nome">Nome do seu amigo *</label><input type="text" id="nome" name="nome_destinatario" />
		<label for="email">E-mail do seu amigo *</label><input type="email" id="email" name="email_destinatario" /><span id="emailInfo"></span>
		...
		<label for="mensagem">Mensagem *</label><textarea id="mensagem" name="mensagem"></textarea>
                ...
                <input type="hidden"  name="tipo_curso" value="<?php echo $curso['tipo_curso'];?>" />
