...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    ...
    <body>
        <form action="<?php echo site_url().$action;?>" id="form-contato" method="post">
	...
	<div>
		...
		<label for="nome">Nome *</label><input type="text" id="name" name="nome" /><span id="nameInfo"></span>
		...
		<label for="empresa">Empresa</label><input type="text" id="empresa" name="empresa" />
                <label for="empresa">cnpj</label><input type="text" id="cnpj" name="cnpj" /><span id="cnpjInfo"></span>
		<label for="cargo">Cargo</label><input type="text" id="cargo" name="cargo" />
		<label for="email">E-mail *</label><input type="email" id="email" name="email" /><span id="emailInfo"></span>
		<span>
			<label for="tel">Telefone</label><input type="text" id="tel" name="tel" />
			<label for="cel">Celular</label><input type="text" id="cel" name="cel" />
		</span>
               
                <label for="mensagem">Mensagem *</label><textarea id="message" name="mensagem" ></textarea>
