        ...
        <div class="bg2">
            <header>
                    ...
                    <div class="login">
                        <form name="login" action="" method="">
                         ...
                         <form action="<?php echo site_url() ;?>loginlogout/login" method="post">
                             ...
                             <input id="usuario-senha" type="password" onBlur="if (this.value == '') {this.value = 'Senha';}" onFocus="if (this.value == 'Senha') {this.value = '';}" name="senha" value="Senha">
                ...
                <?php if ($this->session->userdata('SessionIdAluno')>0):?>
                    ...
                    <div class="logado">Olá <?php echo $this->session->userdata('SessionNomeAluno');?>, bem vindo! Acesse sua área restrita clicando <a href="<?php echo site_url();?>area_restrita_meus_cursos">aqui</a> ou realize <a href="<?php echo site_url();?>loginlogout/logout">logoff</a>.</div>
               <?php elseif ($this->session->userdata('SessionIdEmpresa')>0):?>
              
                    <div class="logado">Olá <?php echo $this->session->userdata('SessionNomeEmpresa');?>, bem vindo! Acesse sua área restrita clicando <a href="<?php echo site_url();?>area_restrita_meus_cursos_empresa">aqui</a> ou realize <a href="<?php echo site_url();?>loginlogout/logout">logoff</a>.</div>
                 <?php else:?>
