                ...
                <div class="left-internas" style="width:710px;">
				  ...
				  <div class="miolo-interna">
                     <h3>Central de Downloads</h3>
                     	...
                     	<div class="text-cursos" style="float:left; margin-left:65px; width:600px; margin-top:20px; margin-bottom:10px;">
                    ...
                    <div class="categorias_central_downloads_box">
                     ...
                     <div class="box-search-cursos" style="margin-bottom:20px;">
					    	<h3 style=" width:442px; line-height:100%; font-size:12.5px; padding-top:10px;">Arquivos<br>em Destaque</h3>
					    	<form action="<?php echo site_url('central_downloads/lista_downloads');?>" method="GET">
								...
								<div class="lista-autodiagnostico" style="margin-top:15px; margin-bottom:10px">
									...
									<h2><?php echo $item->titulo; ?></h2>
                                                                        ...
                                                                        <p>Extensão: <?php echo $dadosversao[0]['formato_arquivo'].'('.$dadosversao[0]['descricao_extensao'].')'; ?></p>
                                                                         ...
                                                                         <p><label><input type="checkbox" name="aceite-termos-<?php echo $dadosversao[0]['id_download_versoes']; ?>"> Li e aceito os <a class="various" data-fancybox-type="iframe" href="<? echo site_url('contato/aceite_me/4');?>">termos de uso</a></label></p>
									<p><h3 style="position:relative; top:20px;">R$ <?php echo $item->preco; ?></h3></p><br>
                                                                        <p><a href="<?  echo site_url('carrinho/adicionar/'.$dadosversao[0]['id_download_versoes'].'/DO/false');?>"><img src="<?php echo base_url();?>assets/img/btn-comprar-peq.png"/></a></p>
								</div>
								<?php endif; ?>
                                                       <?php endforeach; ?>
