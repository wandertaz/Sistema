						...
						<?php endforeach; ?>
		                 ...
		                 <div class="autodiagnostico-resultado-opcao">                                   
                                    ...
                                    <?php else:?>
                                        ...
                                        <a href="<?php echo site_url('area_restrita_autodiagnosticos/envio_email_resultado/'.$inscricao_id.'/'.$acesso['tipoacesso']); ?>">
                                        <span class="botao-laranja-autodiagnostico">Enviar por email</span><span class="ponta-botao-laranja"></span></a>
                                   <?php endif;?> 
		                 </div>
