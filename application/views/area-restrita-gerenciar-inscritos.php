              ...
              <div class="content-interna" style="width:780px; background:white;">
                  ...
                  <div class="miolo-interna">
                     ...
                     <ul class="lista-meus-cursos">
                       ...
                       <?php if($this->session->userdata('SessionTipoPessoa')=='J'):?>
                        ...
                        <?php if($this->session->userdata('SessionIdEmpresa'))?>
                ...
                <div class="centerCursos equalH-meus-cursos">
                 ...
                 <div class="selecionar-curso">
                    <form id="formulario-curso" name="formulario-curso" action="<?php echo site_url(); ?>gerenciarinscritos" method="post">
               ...
               <?php if (isset($cursos)): ?>
                ...
                <h4>Alunos Cadastrados</h4>
                 <div style="position: absolute;width: 565px;margin-top: -38px;">
                     <?php if(calcula_inscricoes_restantes($cursos['id_inscricao'])>0):?>
                     <a style="float: right;border:0; text-decoration:none;" href="<?php echo site_url();?>gerenciarinscritos/buscarcadastrados">
                      <img style="border:0; text-decoration:none;" src="<?php echo base_url(); ?>assets/img/add_new_inscrito.png" alt="Adicionar Novo" />
                      
                    </a>
                     <?php else:?>
                     <a style="float: right;border:0; text-decoration:none;" href="">
                        <img style="border:0; text-decoration:none;" src="<?php echo base_url(); ?>assets/img/add_new_inscrito_gray.png" alt="Adicionar Novo | Desabilitado" />
                     </a>
                     <?php endif;?>
                     
                 </div>
                <?php if (isset($inscritos_notas)): ?>
                <p style="display: block;text-align: center;margin: 40px 0 0 0;text-transform: uppercase;color: red;"><?php echo($mensagem[0]) ; ?></p>
                <table width="100%" border="0" class="tabelaAreaRestrita">
                  <tr>
                    ...
                    <td style="border:none;"><h6>Detalhes</h6></td>
                  ...
                  <tr>
                    ...
                    <td><center>
                        <a style="color:#f8931f;text-decoration:none;" href="<?php echo site_url();?>maisdetalhesaluno/index/<?php echo $item["inscrito_id"];?>" data-fancybox-type="iframe" class="various">
                            ver mais
                        </a>
                    </center></td>
