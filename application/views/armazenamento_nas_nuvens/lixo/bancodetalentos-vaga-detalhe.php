          ...
          <?php endif;?>
			<?php endif; ?>
		     ...
		     <ul id="description-vaga">
		       <li><strong>Faixa Salarial: </strong><span><?php echo $vaga->faixa_salarial ? $vaga->faixa_salarial->pretencaosalarial_nome : '-';  ?></span></li>
			       	...
			       	<span>
						<?php foreach($vaga->idiomas as $idioma): ?>
							<?php echo $idioma->nome_idioma; ?>
								 (Leitura: <?php echo $niveis_idiomas[$idioma->nivel_leitura]; ?>,
								 Escrita: <?php echo $niveis_idiomas[$idioma->nivel_escrita]; ?>,
								 Conversação: <?php echo $niveis_idiomas[$idioma->nivel_conversacao]; ?>)
								<br />
						<?php endforeach; ?>
					</span></li>
					<li><strong></strong><span></span></li>
