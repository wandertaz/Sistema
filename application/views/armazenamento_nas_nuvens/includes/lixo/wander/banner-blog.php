	...
	<div class="banner-internas">
		...
		<?php if(isset($post_destaque) && $post_destaque): ?>
			...
			<div id="colunista-da-semana">
                ...
                <h4 style="margin-top:0px;">Último post: <a href="<?php echo site_url('blog/ver_post/'.$post_destaque[0]->id.'/'.$post_destaque[0]->url); ?>" style="color:black; text-decoration:none;"><?php echo $post_destaque[0]->titulo; ?></a></h4>
                </div>
			</div>
		<?php endif; ?>
