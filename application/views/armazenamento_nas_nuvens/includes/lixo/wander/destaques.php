			...
			<li>
				<div>
					...
					<h4><a href="#"><?php echo $destaque->titulo; ?></a></h4>
                                        <?php
                                            $dadosversao=  retorna_ultima_versao_downloads($destaque->id_downloads);                                           
                                        ?>
                                       
					<p class="desc"><?php echo $destaque->descricao; ?></p>
                                        <p>Versão: 1.<?php echo $dadosversao[0]['numero_versao']; ?></p>
                                        <p><input type="checkbox"   name="aceite-termos-<?php echo $destaque->id_downloads; ?>"> Li e aceito os <a class="various" data-fancybox-type="iframe" href="<?  echo site_url('contato/aceite_me/4');?>" target="_blank">termos de uso</a></p>
