...
class Posts_colunistas extends CI_Controller {

	var $titulo 		= 'Colunistas';
	var $dir 			= 'multitools/posts_colunistas/';
	var $controller 	= 'multitools/posts_colunistas';
	var $title_sing 	= 'Colunista';
	var $per_page 		= 20;
	var $table 			= 'posts_colunistas';
	var $join			= NULL;
