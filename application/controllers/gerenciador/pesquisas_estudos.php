...
class Pesquisas_estudos extends CI_Controller {

	var $titulo 		= 'Pesquisas e Estudo';
	var $dir 			= 'multitools/pesquisas_estudos/';
	var $controller 	= 'multitools/pesquisas_estudos';
	var $title_sing 	= 'Pesquisa/Estudo';
	var $per_page 		= 20;
	var $table 			= 'pesquisas_estudos';
