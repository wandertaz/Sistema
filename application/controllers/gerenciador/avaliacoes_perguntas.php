...
class Avaliacoes_perguntas extends CI_Controller {

	var $titulo 		= 'Avaliações';
	var $dir 			= 'multitools/avaliacoes_perguntas/';
	var $controller 	= 'multitools/avaliacoes_perguntas';
	var $title_sing 	= 'Pergunta';
	var $per_page 		= 20;
	var $table 			= 'avaliacoes_perguntas';
	var $join			= NULL;
