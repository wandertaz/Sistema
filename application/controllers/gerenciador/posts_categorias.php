...
class Posts_categorias extends CI_Controller {

	var $titulo 		= 'Categorias';
	var $dir 			= 'multitools/posts_categorias/';
	var $controller 	= 'multitools/posts_categorias';
	var $title_sing 	= 'Categoria';
	var $per_page 		= 20;
	var $table 			= 'posts_categorias';
	...
	public function salvar()
	{
		...
		if(isset($data["id"]) && $data["id"])
			...
			$data['url']   = sanitize_title_with_dashes($data['categoria']);
	...
	public function buscar(){
		...
		//Parâmetros de busca
		$data_busca[$this->table.'.categoria']  = $this->input->get('s');
