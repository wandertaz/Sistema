...
class Comentarios extends CI_Controller {
	...
	var $titulo 		= 'Comentários';
	var $dir 			= 'multitools/comentarios/';
	var $controller 	= 'multitools/comentarios';
	var $title_sing 	= 'Comentário';
	var $per_page 		= 20;
	var $table 			= 'comentarios';
	var $join			= NULL;
	var $areas			= array('ART' => 'Artigo', 'PES' => 'Pesquisas e Estudos', 'GAL' => 'Galerias', 'POD' => 'Podcasts', 'VID' => 'Vídeos', 'NOT' => 'Notícias', 'POS' => 'Posts');
	...
	public function buscar(){
		...
		$data_busca[$this->table.'.titulo_registro']  = $this->input->get('s');

		//Registros
		$offset = $this->input->get('per_page');
		$data['registros'] = $this->default_model->get_by_search($this->table, array($this->table.'.*'), NULL, $offset, $this->per_page, $data_busca, $this->join, $this->table.'.id', 'DESC');
