...
class Cursos_incompany extends CI_Controller {

	var $titulo 		= 'Cursos "In Company"';
	var $dir 			= 'multitools/cursos_incompany/';
	var $controller 	= 'multitools/cursos_incompany';
	var $title_sing 	= 'Curso "In Company"';
	var $per_page 		= 20;
	var $table 			= 'cursos_incompany';
