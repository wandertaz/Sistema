...
class Programas_desenvolvimento extends CI_Controller {

	var $titulo 		= 'Programas de Desenvolvimento';
	var $dir 			= 'multitools/programas_desenvolvimento/';
	var $controller 	= 'multitools/programas_desenvolvimento';
	var $title_sing 	= 'Programa de Desenvolvimento';
	var $per_page 		= 20;
	var $table 			= 'programas_desenvolvimento';
