...
class Videos extends CI_Controller {
	...
	var $titulo 		= 'Videos';
	var $dir 			= 'multitools/videos/';
	var $controller 	= 'multitools/videos';
	var $title_sing 	= 'Vídeo';
	var $per_page 		= 20;
	var $table 			= 'videos';
	var $join			= NULL;
	...
	public function salvar()
	{
		...
		$config['allowed_types'] = 'rv|mpeg|mpg|mpe|qt|mov|avi|movie|jpeg|jpg|gif|png';
		$this->load->library('upload', $config);

		//Upload da imagem de chamada
