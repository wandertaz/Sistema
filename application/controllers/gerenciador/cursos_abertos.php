...
class Cursos_abertos extends CI_Controller {

	var $titulo 		= 'Cursos Abertos';
	var $dir 			= 'multitools/cursos_abertos/';
	var $controller 	= 'multitools/cursos_abertos';
	var $title_sing 	= 'Curso Aberto';
	var $per_page 		= 20;
	var $table 			= 'cursos_abertos';
