...
class Artigos extends CI_Controller {
	...
	var $titulo 		= 'Artigos';
	var $dir 			= 'multitools/artigos/';
	var $controller 	= 'multitools/artigos';
	var $title_sing 	= 'Artigo';
	var $per_page 		= 20;
	var $table 			= 'artigos';
	...
	public function index($offset = 0){
		...
		//Registros
		$data['registros'] = $this->default_model->get_all($this->table, array($this->table.'.*, idiomas.nome as idioma'), $offset, $this->per_page, array(), $this->join, $this->table.'.data_publicacao', 'DESC');
	...
	public function salvar()
	{
		//Recebe Post
		$data = $_POST;
		$data['data_publicacao'] = w3c_date($_POST['data_publicacao']);
	...
	public function buscar(){
		...
		$data['registros'] = $this->default_model->get_by_search($this->table, array($this->table.'.*, idiomas.nome as idioma'), NULL, $offset, $this->per_page, $data_busca, $this->join, $this->table.'.data_publicacao', 'DESC');
