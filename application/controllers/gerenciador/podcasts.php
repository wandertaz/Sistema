...
class Podcasts extends CI_Controller {
	...
	var $titulo 		= 'Podcasts';
	var $dir 			= 'multitools/podcasts/';
	var $controller 	= 'multitools/podcasts';
	var $title_sing 	= 'Podcast';
	var $per_page 		= 20;
	var $table 			= 'podcasts';
	var $join			= NULL;
	...
	public function salvar()
	{
		...
		$config['allowed_types'] = 'mp3|mid|mpga|aif|ram|rpm|ra|wav|jpeg|jpg|gif|png';
