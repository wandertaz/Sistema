...
class datas_especiais extends CI_Controller {

	var $titulo 		= 'Datas datas Especiais';
	var $dir 			= 'multitools/datas_especiais/';
	var $controller 	= 'multitools/datas_especiais';
	var $title_sing 	= 'Data Especial';
	var $per_page 		= 20;
	var $table 			= 'datas_especiais';
	var $join			= NULL;
	...
	public function editar($id){
		...
		//Busca registro
		$data['registro'] = $this->default_model->get_by_id($this->table, $id, array('*'), NULL, NULL, 'id');
